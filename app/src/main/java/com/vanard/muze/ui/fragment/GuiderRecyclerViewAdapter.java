...
public class GuiderRecyclerViewAdapter extends RecyclerView.Adapter<GuiderRecyclerViewAdapter.ViewHolder> {
    ...
    public GuiderRecyclerViewAdapter(List<DataGuider> items) {
        mValues = items;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_guider, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mIdView.setText(mValues.get(position).getMuseum());
